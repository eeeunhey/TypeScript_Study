...
export const CURRICULUM = [
    {
      date: "2025-12-15",
      lecture: "1. 원시타입-모든 타입의 기본" ,
      task: "1. 원시타입 문제 ",
      path: "/study/basicType"
    },
        {
      date: "2025-12-15",
    ...
    {
      date: "2025-12-18",
      lecture: "10. 제네릭 타입 - 타입도 매개변수처럼  11. 제네릭 타입 응용",
      task: "11. 제네릭 타입 정리 및 문제 풀이",
      path: "/study/generic"
    },

        {
      date: "2025-12-18",
      lecture: "12. 리터럴 타입 - 문자 그대로",
      task: "12. 리터럴 타입 정리 문제 풀이",
      path: "/study/literal"
    },
    ...
    {
      date: "2025-12-21",
      lecture: "1. 프로젝트 소개  2. 환경설정 - webpack, 바벨  3. 라우터 설정 - 레이아웃 있는 페이지  3-1. Lazy Loading",
      task: "webpack/바벨 셋팅 확인 + url 변화에 따른 페이지 전환 + 레이아웃(sidebar) 유지",
      path: "/study/day7"
    },
  ];